...
# change this to reflect order of sensors:
    ...
    all_but_351_average = average_list[:no_columns] + average_list[no_columns+1:]
    ...
    print("---")
    calibrated_average_speed_list_all = calibrated_average_speed_list[:no_columns] + calibrated_average_351 + calibrated_average_speed_list[no_columns:]
    calibrated_average_speed_list_all_min = calibrated_average_speed_list_min[:no_columns] + calibrated_average_351_min + calibrated_average_speed_list_min[no_columns:]
    calibrated_average_speed_list_all_max = calibrated_average_speed_list_max[:no_columns] + calibrated_average_351_max + calibrated_average_speed_list_max[no_columns:]
    ...
    print("selected_columns")
    all_but_351_df = selected_columns.drop(selected_columns.columns[[no_columns]], axis = 1)
    ...
    for i in range(len(all_but_351_df.columns)):
        calibrated_df[all_but_351_df.columns[i]] = all_but_351_df.iloc[:, i] * delta_gradient_list[i] + delta_intercept_list[i]
    print(calibrated_df)

    for i in range(len(all_but_351_df.columns)):
        calibrated_df_min[all_but_351_df.columns[i]] = all_but_351_df.iloc[:, i] * (delta_gradient_list[i] - delta_gradient_error_list[i]) + (delta_intercept_list[i] - delta_intercept_error_list[i])
    print(calibrated_df_min)

    for i in range(len(all_but_351_df.columns)):
        calibrated_df_max[all_but_351_df.columns[i]] = all_but_351_df.iloc[:, i] * (delta_gradient_list[i] + delta_gradient_error_list[i]) + (delta_intercept_list[i] + delta_intercept_error_list[i])
    ...
    calibrated_average_speed_list_all = mu_list[:no_columns] + calibrated_average_351 + mu_list[no_columns:]
    ...
    calibrated_average_speed_list_all_min = mu_list_min[:no_columns] + calibrated_average_351_min + mu_list_min[no_columns:]
    ...
    calibrated_average_speed_list_all_max = mu_list_max[:no_columns] + calibrated_average_351_max + mu_list_max[no_columns:]
